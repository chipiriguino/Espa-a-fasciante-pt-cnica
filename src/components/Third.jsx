      ...
      <div className="width-third-card">
        <CardDeck>
          <div>
            <Card>
              <Card.Text>
                <i className="cat-sub-color">
                  <b>{props.cat}</b> | {props.subcategory}
                </i>
              </Card.Text>
              <Card.Text className="title-card font-title-third hidden">
                {props.title}
              </Card.Text>
              <Card.Text className="hidden">{props.summary}</Card.Text>
              ...
              <Card.Body>
                <Card.Text className="hidden-first">{props.summary}</Card.Text>
                <Card.Text className="query-fafa">
                  <p className="bold">{props.author}</p>
                  <div className="align-fafa">
                    <div className="date3-align">
                      <p className="font-size cat-sub-color">
                        {props.date} - <b>{props.read}</b>
                      </p>
                    </div>
                    <div className="icons-third">
                      <img src="/images/fb-black.png" width="25" alt="search" />
                      <img
